        ...
        <div className="relative w-full h-[120vh] sm:h-[100vh]">
            ...
            <div data-aos="fade-up" className="absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                <div className="flex items-center justify-center flex-col w-full h-full">
                    <div>
                        <h1 className="text-[25px] mb-4 md:mb-0 text-center sm:text-[45px] lg:text-[65px] tracking-[0.7rem] text-white font-bold uppercase">
                            Enjoy The Ride
                        </h1>
                        <p className="md:text-lg text-center text-sm text-white font-normal [word-spacing:5px]">Get your hands on the best cars for the lowest price</p>
                    </div>
