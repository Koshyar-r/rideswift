    ...
    return (
        <div className="bg-white rounded-lg p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-center justify-center gap-8 mt-4 sm:mt-12 w-[95%] sm:w-[80%]">
            ...
            <div className="flex items-center space-x-6">
                ...
                <div>
                    <p className="text-lg font-medium mb-[0.2rem]">Car Model</p>
                    <input type="text" placeholder="Choose your favorite" className="outline-none border-none placeholder:text-gray-800" />
                </div>
            </div>
            {/* 2nd SEARCH INPUT */}
            <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-6">
                ...
                <div>
                    <p className="text-lg font-medium mb-[0.2rem]">Passengers</p>
                    <p className="text-base font-normal">Number of Passengers</p>
                </div>
            </div>
        </div>
    )
